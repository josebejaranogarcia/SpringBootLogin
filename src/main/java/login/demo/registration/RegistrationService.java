...
import login.demo.emails.EmailSender;
...
public class RegistrationService {
    ...
    private static final String CONFIRMATION_LINK=  "http://localhost:8090/api/v1/registration/confirm?token=";
    ...
    public String register(RegistrationRequest request) {
        ...
        emailSender.send(request.getEmail(),
                createEmail(request.getName(), CONFIRMATION_LINK + token));
    ...
    private String createEmail(String name, String confirmationLink) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "       <blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + confirmationLink + "\">Activate Now</a> </p></blockquote>\n Link will expire in 15 minutes. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
